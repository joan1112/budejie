...
#define kCycleScrollViewInitialPageControlDotSize CGSizeMake(20, 20)
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        ...
        case SDCycleScrollViewPageContolStyleClassic:
        {
            ...
            pageControl.userInteractionEnabled = NO;
            pageControl.currentPage = indexOnPageControl;
            pageControl.transform=CGAffineTransformScale(CGAffineTransformIdentity, 1.4, 1.4);
            [self addSubview:pageControl];
            _pageControl = pageControl;
        }
            break;
...
{
    [[[SDWebImageManager sharedManager] imageCache] clearWithCacheType:SDImageCacheTypeNone completion:nil];
}
